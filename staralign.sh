...
/usr/bin/time -v htseq-count --stranded=yes mmu/27_Aligned.out.sam Mus_musculus.GRCm39.112.gtf
/usr/bin/time -v htseq-count --stranded=reverse mmu/27_Aligned.out.sam Mus_musculus.GRCm39.112.gtf

/usr/bin/time -v htseq-count --stranded=yes mmu/32_Aligned.out.sam Mus_musculus.GRCm39.112.gtf
/usr/bin/time -v htseq-count --stranded=reverse mmu/32_Aligned.out.sam Mus_musculus.GRCm39.112.gtf
